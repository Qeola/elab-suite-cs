...
const columns = () => [
  ...
  columnHelper.accessor("debit", {
    ...
    header: () => <span className="text-nowrap">Net Debit</span>,
  }),
  columnHelper.accessor("credit", {
    ...
    header: () => <span className="text-nowrap">Net Credit</span>,
  }),
  columnHelper.accessor("actions", {
    cell: (info: any) => {
      ...
      return (
        <a
          href={`/dashboard/account/reports/trial-balance/${slug}`}
...
function TrialBalance({ tableData }: { tableData: any }) {
